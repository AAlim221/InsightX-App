...
const Template4 = () => {
  ...
  const questions = [
    { id: "q1", text: "1. How often do you use public transportation?", options: ["Daily", "A few times a week", "Once in a while", "Never"] },
    { id: "q2", text: "2. What type of public transportation do you use most often?", options: ["Rickshaw ", "Bus",
         "Train ", "Others"] },
    { id: "q3", text: "3. How would you rate the cleanliness of public transportation?", options: ["Very clean", 
        "Mostly clean", "Somewhat dirty", "Dirty"] },
    { id: "q4", text: "4. Do you feel safe while using public transportation?", options:["Always", 
    "Most of the time","Sometimes ", "Never", ]},
    { id: "q5", text: "5. How easy is it to find information about public transportation schedules?", options: ["Very Easy", "Easy", "Neutral", "Difficult"] },
    { id: "q6", text: "6. Would you recommend public transportation to others?", options: ["Definitely", 
