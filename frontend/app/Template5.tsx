...
const Template5 = () => {
  ...
  const questions = [
    { id: "q1", text: "1. How often do you order food online?", options: ["Daily", "A few times a week", "Once in a while", "Never"] },
    { id: "q2", text: "2. Which food delivery app do you use most frequently?", options: [" Uber Eats ", "DoorDash",
         "FoodPanda ", "Others"] },
    { id: "q3", text: "3. What is your primary reason for choosing a food delivery service?", options: ["Variety of restaurants", 
        "Speed of delivery", "Cost and discounts", "App usability"] },
    { id: "q4", text: "4. What is your preferred method of payment for online food orders?", options:["Credit/Debit Card", 
    "Digital Wallets (e.g., PayPal, Apple Pay)","Cash on Delivery ", "Gift Cards or Coupons", ]},
    { id: "q5", text: "5. How satisfied are you with the quality of food delivered?", options: ["Very Satisfied", "Satisfied", "Neutral", "Dissatisfied"] },
    { id: "q6", text: "6. How likely are you to recommend your preferred food delivery app to others?", options: ["Very Likely", "Likely", "Neutral", "Unlikely"] },
  ];
      ...
      <ScrollView className="px-4">
        ...
        <SafeAreaView style={{ backgroundColor: "#30DCB7" }} className="w-full min-h-[120px] mt-4 mb-4 rounded-lg 
          flex items-center justify-center">
            <View style={{ backgroundColor: "white" }} className="w-[90%] p-4 rounded-lg shadow ">
                <Text className="text-black text-center font-bold">Your Journey Matters</Text>
             </View>
          </SafeAreaView>
        ...
        <SafeAreaView style={{ backgroundColor: "#30DCB7" }} className="w-full min-h-[160px] mt-4 rounded-lg flex items-center justify-center">
          <View className="w-[90%] mt-2 space-y-2">
           ...
           Public Transportation Experience Survey
           </Text>
           </View>
           <View className="w-[90%] mt-4 space-y-2 mb-6">
           <Text style={{ backgroundColor: "white" }} className="text-black text-center font-bold py-4 px-4 rounded-lg">
           This survey helps understand people's experiences with public transportation.
            </Text>
           </View>
          </SafeAreaView>
